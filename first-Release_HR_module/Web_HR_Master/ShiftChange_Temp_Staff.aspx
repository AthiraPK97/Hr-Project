<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ShiftChange_Temp_Staff.aspx.cs" Inherits="Web_HR_Master.ShiftChange_Temp_Staff" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="form-group row">
    <div class="col-lg-8 ml-auto d-flex">
        <asp:Button ID="Btn_Addshift" runat="server" Text="ADD SHIFT" class="btn btn-success mr-2" OnClick="Btn_Add_Click" Width="156px" />
