...
{
    public partial class Shift_report : System.Web.UI.Page
    {
        ...
        protected void Btn_view_Click(object sender, EventArgs e)
        {
            ...
            ds = objservice.doctor_Shiftreport(ddl_branch.SelectedValue,txt_fromdate.Text);
            ds1 = objservice.employee_Shiftreport(ddl_branch.SelectedValue);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("Reports/Shift_report.rdlc");
