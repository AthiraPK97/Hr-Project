<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Doctors_registration.aspx.cs" Inherits="DoctorsOnDuty.Doctors_registration" %>
...
<%--<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
    ...
    <%--<div class="form-group row">
        ...
        <div class="col-lg-8">
            <asp:TextBox ID="txt_paymentterms" runat="server" CssClass="form-control" required="required"></asp:TextBox>
        </div>
    </div>--%>
    ...
    <div class="form-group row" runat="server" id="div_monthly">
        ...
        <div class="col-lg-8">
            <asp:GridView ID="Gridview1" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="Gridview1_RowDeleting" OnRowCommand="GridView1_RowCommand" OnRowDeleted="Gridview1_RowDeleted">
                <Columns>
                    <asp:BoundField DataField="RowNumber" HeaderText="Row Number" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger"  />
                    ...
                    <asp:TemplateField HeaderText="From time" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger">
                        <ItemTemplate>                            
                            <asp:TextBox ID="txt_frmtime" runat="server" Width="100px" CssClass="form-control" type="time"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="To Time" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger">
                        <ItemTemplate>                            
                            <asp:TextBox ID="txt_totime" runat="server" Width="100px" CssClass="form-control" type="time"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div class="col-lg-8">
            <asp:GridView ID="Gridview2" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="Gridview2_RowDeleting" OnRowDeleted="Gridview2_RowDeleted" OnRowCommand="GridView2_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="From Time" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger">
                        <ItemTemplate>                            
                            <asp:TextBox ID="txt_frmtime" runat="server" Width="150px" CssClass="form-control" type="time"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="To Time" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger">
                        <ItemTemplate>                            
                            <asp:TextBox ID="txt_totime" runat="server" Width="150px" CssClass="form-control" type="time"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Larger">
                        <ItemTemplate>                            
                        ...
                        <FooterStyle HorizontalAlign="Right" />
                        <FooterTemplate>
                            <asp:Button ID="ButtonAdd" runat="server" Text="Add New Row" OnClick="ButtonAdd_Click1" BackColor="#666699" ForeColor="White" BorderColor="#666699" />
                        </FooterTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
