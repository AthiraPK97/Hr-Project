<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Norms_Prediction.aspx.cs" Inherits="DoctorsOnDuty.Norms_Prediction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group row">
        <label class="col-lg-1 col-form-label">From Time </label>
        <div class="col-lg-4">
            <asp:TextBox ID="txt_fromtime" runat="server" CssClass="form-control" TextMode="Time"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
        <label class="col-lg-1 col-form-label">To Time </label>
        <div class="col-lg-4">
            <asp:TextBox ID="txt_totime" runat="server" CssClass="form-control" TextMode="Time"></asp:TextBox>
        </div>        
    </div>
        ...
        <asp:Table ID="Table1" runat="server" BackColor="#EFF3FB" HorizontalAlign="Center" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" BackColor="#002b84" Style="text-align: center;">
                    <asp:Label ID="Label5" runat="server" Text="NORMS" ForeColor="White" Font-Size="Large" Font-Names="times New Roman" Font-Bold="true"></asp:Label><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
