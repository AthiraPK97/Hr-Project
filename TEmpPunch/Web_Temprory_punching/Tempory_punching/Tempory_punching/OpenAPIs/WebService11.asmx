    ...
    <div id="content">
      ...
      <span>
          ...
          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="WebService1.asmx?WSDL">Service Description</a>. </p>
              ...
              <li>
                <a href="WebService1.asmx?op=Get_Branch">Get_Branch</a>
              ...
              <li>
                <a href="WebService1.asmx?op=Get_Branch_Type">Get_Branch_Type</a>
              ...
              <li>
                <a href="WebService1.asmx?op=User_Registration">User_Registration</a>
              ...
              <li>
                <a href="WebService1.asmx?op=delete_null_data">delete_null_data</a>
              ...
              <li>
                <a href="WebService1.asmx?op=delete_select">delete_select</a>
              ...
              <li>
                <a href="WebService1.asmx?op=getPunchDetails">getPunchDetails</a>
              ...
              <li>
                <a href="WebService1.asmx?op=get_report">get_report</a>
              ...
              <li>
                <a href="WebService1.asmx?op=login">login</a>
              ...
              <li>
                <a href="WebService1.asmx?op=punchIn">punchIn</a>
              ...
              <li>
                <a href="WebService1.asmx?op=punchOut">punchOut</a>
              ...
              <li>
                <a href="WebService1.asmx?op=updatePunchInDetails">updatePunchInDetails</a>
              ...
              <li>
                <a href="WebService1.asmx?op=update_select">update_select</a>
              ...
              <li>
                <a href="WebService1.asmx?op=view_clinic_patient_details">view_clinic_patient_details</a>
              ...
              <li>
                <a href="WebService1.asmx?op=view_details">view_details</a>
              ...
              <li>
                <a href="WebService1.asmx?op=view_details_by_name">view_details_by_name</a>
              ...
              <li>
                <a href="WebService1.asmx?op=view_lab_patient_details">view_lab_patient_details</a>
              ...
              <li>
                <a href="WebService1.asmx?op=view_pharmacy_patient_details">view_pharmacy_patient_details</a>
